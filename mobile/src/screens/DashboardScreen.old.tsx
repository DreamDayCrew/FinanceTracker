...
export default function DashboardScreen() {
  ...
  const { data: paymentOccurrences = [] } = useQuery({
    queryKey: ['/api/payment-occurrences-current'],
    queryFn: async () => {
      const now = new Date();
  ...
  const { data: creditCardBills = [] } = useQuery({
    queryKey: ['/api/credit-card-bills'],
  ...
  const onRefresh = useCallback(async () => {
    ...
    await Promise.all([
      refetch(), 
      queryClient.refetchQueries({ queryKey: ['/api/monthlyExpenses'] }),
      queryClient.refetchQueries({ queryKey: ['/api/monthlyCreditCardSpending'] }),
      queryClient.refetchQueries({ queryKey: ['/api/salary-profile/next-paydays'] }),
      queryClient.refetchQueries({ queryKey: ['/api/salary-cycles'] }),
      queryClient.refetchQueries({ queryKey: ['/api/payment-occurrences-current'] }),
